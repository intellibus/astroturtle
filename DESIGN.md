...
- [astroturtle design](#astroturtle-design)
...
`astroturtle` is designed to communicate with the `turtle` tab management APIs.

## How is it different from what I already use?

**WORK IN PROGRESS**: `astroturtle` is still in the `design` phase.
...
`astroturtle` is a part of the [Open Source Universe](https://github.com/intellibus/approach). All Projects in the [Open Source Universe](https://github.com/intellibus/approach) follow the same [Contribution Guidelines & Process](https://github.com/intellibus/approach).
...
`astroturtle` only plans to initially support Typescript & JavaScript Applications. However, we would love for the community to contribute versions for other languages (Java, Go, etc.)
